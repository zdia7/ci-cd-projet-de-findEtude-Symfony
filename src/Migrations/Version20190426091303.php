 ...
 */
final class Version20190426091303 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE technologie (id INT AUTO_INCREMENT NOT NULL, technologie VARCHAR(255) DEFAULT NULL, nom_cellule VARCHAR(255) DEFAULT NULL, occurences INT DEFAULT NULL, total INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
